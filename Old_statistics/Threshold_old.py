...
LEGACY_EXCEL_SHEETS_FROM_SCREENSHOT = [
    {"excel_name": "Complete Dataset", "mapped_to": "complete_dataset"},
    {"excel_name": "Fuel Consumption", "mapped_to": "fuel_consumption"},
    {"excel_name": "Fuel Consumption 2", "mapped_to": "fuel_consumption_2"},
    {"excel_name": "Average Vehicle Speed", "mapped_to": "average_vehicle_speed"},
    {"excel_name": "1a_1 EngineTorque | EngineSpeed", "mapped_to": "1a"},
    {"excel_name": "1a_2 EngineTorque | EngineSpeed", "mapped_to": "1a_2"},
    {"excel_name": "1b EngineTorque | VehicleSpeed", "mapped_to": "1b"},
    {"excel_name": "2a Engine Oil Pressure", "mapped_to": "2a"},
    {"excel_name": "2b Oil Temperature", "mapped_to": "2c"},
    {"excel_name": "2c Intake Air", "mapped_to": "3c"},
    {"excel_name": "3a Gas Temperature", "status": "pending: gas sheet non presente nel sample 399"},
    {"excel_name": "3c Gas Rail", "status": "pending: gas sheet non presente nel sample 399"},
    {"excel_name": "3e ETAS | Rail", "status": "pending: colonne diagnostiche non presenti nel sample 399"},
    {"excel_name": "3f Mixture", "status": "pending: gas sheet non presente nel sample 399"},
    {"excel_name": "3g Mixture", "status": "pending: gas sheet non presente nel sample 399"},
    {"excel_name": "3h-o Cylinder", "status": "pending: gas sheet non presente nel sample 399"},
    {"excel_name": "4a_1 Catalyst", "mapped_to": "4a_1"},
    {"excel_name": "4a_2 Catalyst", "mapped_to": "4a"},
    {"excel_name": "4b Catalyst", "mapped_to": "4b"},
    {"excel_name": "4d Catalyst", "mapped_to": "4d"},
    {"excel_name": "5c Intake", "status": "pending: nome storico ambiguo nella schermata"},
    {"excel_name": "Engine Life", "status": "pending: sheet non definito in Threshold_old config 399"},
    {"excel_name": "Engine Overspeed", "mapped_to": "engine_over_speed"},
    {"excel_name": "Catalyst Temperature", "mapped_to": "4g_doc_upstream_temperature"},
    {"excel_name": "Misfire-Knock", "status": "pending: colonne non presenti nel sample 399"},
    {"excel_name": "Engine Coolant", "mapped_to": "3a"},
    {"excel_name": "Oil Temperature", "mapped_to": "2c"},
    {"excel_name": "Boost Pressure", "status": "pending: colonne non presenti nel sample 399"},
    {"excel_name": "Ambient Pressure", "status": "pending: colonne non presenti nel sample 399"},
    {"excel_name": "Oil Pressure", "mapped_to": "2a"},
    {"excel_name": "Low Catalyst", "status": "pending: colonne non presenti nel sample 399"},
]
